...
insert into book(id, image, title, author_id, status) values(1, 'http://localhost/biblio/books/images/1', 'The Iliad', 1, 'UNAVAILABLE');
...
insert into book(id, image, title, author_id, status) values(5, 'http://localhost/biblio/books/images/5', '1994', 4, 'DEACTIVATED');
