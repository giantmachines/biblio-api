...
insert into book(id, image, title, author_id, active) values(5, 'http://localhost/biblio/books/images/4', '1994', 4, 0);

insert into book_status(id, value, user_id, book_id) values(1, 0, 1, 1);
insert into book_status(id, value, user_id, book_id) values(2, 1, null, 2);
insert into book_status(id, value, user_id, book_id) values(3, 1, null, 3);
insert into book_status(id, value, user_id, book_id) values(4, 1, null, 4);
insert into book_status(id, value, user_id, book_id) values(5, 4, null, 5);
